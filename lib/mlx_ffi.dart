...
final class Mlx {
  ...
  static DynamicLibrary _openDynamicLibrary(String? overridePath) {
    ...
    if (Platform.isLinux) {
      return DynamicLibrary.open('libmlxc.so');
    }
    if (Platform.isWindows) {
      return DynamicLibrary.open('mlxc.dll');
    }
  ...
  void dispose() {
    ...
    _disposed = true;
    _check(bindings.mlx_stream_free(defaultStream), 'mlx_stream_free');
  }
